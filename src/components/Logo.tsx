...
// import React from 'react';
// import { cn } from '@/lib/utils';
// import logoImg from '@/assets/Logo.png'; // Importer l'image depuis le dossier assets
...
//         <img
//           src={logoImg} // L'image est maintenant une variable importée
//           alt="Logo MALIBA-AI"
//           className="w-10 h-10 object-contain" // Adapter la taille de l'image
//         />
//       </div>
//       {showText && (
//         <div className="ml-2 font-heading font-bold text-xl">MALIBA-AI</div>
